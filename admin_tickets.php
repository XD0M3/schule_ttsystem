...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-7">
            <h1 style="text-align: center; margin-top: 15px; margin-bottom: 15px">Deine Tickets</h1>
            <table class="table">
                <thead>
                <tr>
                ...
                <tbody>
                <?php
                $result = $con->query("SELECT * FROM tickets WHERE locked_by = $user_id");
    ...
    <div class="row">
        ...
        <div class="col-7">
            <h1 style="text-align: center; margin-top: 15px; margin-bottom: 15px">Andere Tickets</h1>
            <table class="table">
                <thead>
                <tr>
                    <th scope="col">Ticket ID</th>
                ...
                $resulta = $con->query("SELECT * FROM tickets;");

                while ($rowa = $resulta->fetch_assoc()){
                    if($rowa['closed'] == 'N'){
                        $te = urls("/schulprojekt/support.php?id=". $rowa['support_id']);
                        echo "<tr>";
                        echo '<td><a href="' . $te . '">' . $rowa['support_id'] . "</a></td>";
                        echo "<td>" . $rowa['creator'] . "</td>";
                        echo "<td>" . $rowa['subject'] . "</td>";
                        echo "<td>" . $rowa['locked_by'] . "</td>";
                        echo "<tr>";
                    }
                }
